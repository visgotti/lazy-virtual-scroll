...
.demo-container {
  ...
  &.horizontal {
    ...
    // In a row layout the scroller's inner track is auto-height, so an expanded
    // card would stretch it past the viewport. Pin the track to the viewport and
    // let the card's own body scroll instead.
    .scroll-inner {
      height: 100%;
    }
